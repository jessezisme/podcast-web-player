  ...
  <div>
    ...
    <main class="p-container">
      ...
      <div class="intro" v-if="compPodDetails">
        ...
        <div class="intro_det">
          <h1 class="intro_title" v-if="compPodDetails.publisher">
            {{ compPodDetails.publisher }}
          </h1>
          <p class="intro_sum" v-if="compPodDetails.description">
            {{ compPodDetails.description }}
          </p>
          <p class="intro_more">
            <a class="intro_more-link" title="Link to external podcast site" target="_blank" v-if="compPodDetails.website" v-bind:href="compPodDetails.website">
